...
var writing_tools = [
  ...
  },
  {
    ...
    'description': 'is a series of simple poetry revision tools.',
    'link': 'poetry-experiments/index.html'
  },
]
...
var papers_cs = [
  ...
  },
  {
    ...
    'author': "Katy Gero and Kyle Booten",
...
$(document).ready( function() {
  ...
  $.each(writing_tools, function(i, val) {
    var item = $('<li>');
    item.append("<a target='_blank' href='" + val['link'] + "'>" + val['title'] + "</a>");
    item.append(" <span class=''>" + val['description']);
